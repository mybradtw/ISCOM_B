...
public class BusinessListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back = findViewById(R.id.businessList_back);
        ...
        list = findViewById(R.id.businessList_list);
        initListView();
    ...
    private void gotoBCalendar(){
        Intent intent = new Intent(this, BCalendarActivity.class);
